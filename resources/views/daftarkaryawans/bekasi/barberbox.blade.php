            ...
            <div class="col-md-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title" style=" text-align: center; color:black; font-weight:bold; margin-top:40px;">DAFTAR KARYAWAN/STAFF DI SALON BARBERBOOX BEKASI</h3>
                        </div>
                        ...
                        <div class="panel-body">
                            <table class="table table-bordered" id="tableBarberbox">
                                <thead>
                                <tr>
                                    <th>No</th>
...
@section('footer')
<!--  -->
<script src="{{asset('admin/assets/scripts/barberbox.js')}}"></script>
