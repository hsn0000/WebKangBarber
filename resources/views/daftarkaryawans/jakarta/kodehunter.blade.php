            ...
            <div class="col-md-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title" style=" text-align: center; color:black; font-weight:bold; margin-top:40px;">DAFTAR KARYAWAN/STAFF DI SALON KODE HUNTER BARBER @SHOP</h3>
                        </div>
...
@section('footer')
<!--  -->
<script src="{{asset('admin/assets/scripts/kodehunter.js')}}"></script>
